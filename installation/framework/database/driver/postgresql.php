 ...
 */
class ADatabaseDriverPostgresql extends ADatabaseDriver
{
	/**
	...
	/**
	 * ADatabaseDriverPostgresqlQuery object returned by getQuery
	 *
	 * @var ADatabaseDriverPostgresqlQuery
	 */
	...
	/**
	 * Get the current or query, or new ADatabaseQuery object.
	 *
	 * @param   boolean  $new    False to return the last query set, True to return a new ADatabaseQuery object.
	 * @param   boolean  $asObj  False to return last query as string, true to get ADatabaseQueryPostgresql object.
	 *
	...
	public function getQuery($new = false, $asObj = false)
	{
		if ($new)
		{
			...
			if (!class_exists('ADatabaseQueryPostgresql'))
			{
				throw new RuntimeException('ADatabaseQueryPostgresql Class not found.');
			}

			$this->queryObject = new ADatabaseQueryPostgresql($this);
	 ...
	 *
	 * @return  ADatabaseDriverPostgresql  Returns this object to support chaining.
	 *
	 * @throws  RuntimeException
	 */
