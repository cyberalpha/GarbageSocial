...
class ABIOutput
{
	...
	/** @var string Javascript for the Next button calls */
	var $_nextButton = 'submitForm(\'db\')';
	/** @var string Javascript for the Skip button calls */
	var $_skipButton = null;
	/** @var string Javascript for the Previous button calls */
	var $_prevButton = '';
	 ...
	 */
	function setButtons($prev, $next, $renderSkip = false)
	{
		$this->_nextButton = $next;
		$this->_prevButton = $prev;
		$this->_skipButton = $renderSkip ? $this->_nextButton : null;
	}
...
<div id="buttonbar">
	...
	<?php endif; ?>
	<?php if(!empty($this->_skipButton)): ?>
	<span class="next"><a href="javascript:<?php echo $this->_nextButton ?>" id="skipButton"><?php echo ABIText::_('SKIP') ?></a></span>
	<?php endif; ?>
