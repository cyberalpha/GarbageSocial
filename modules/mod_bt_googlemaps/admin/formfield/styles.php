...
class JFormFieldStyles extends JFormField{
    ...
    protected function  getInput() {
        ...
        $html  = ' <div id="btg-style-message" class="clearfix" style="clear:both;"></div>'
                ...
                . '     	<label>&nbsp;</label>'
                . '     	<button id="btnAddStyle" class="btg-green-btn" versionjl="'.JVERSION.'" baseurl=" '.JURI::root().'">' . JText::_('MOD_BT_GOOGLE_MAP_ADD_STYLE_LABEL') . '</button>'
                . '     	<button id="btnDeleteAllStyle" class="btg-red-btn">' . JText::_('MOD_BT_GOOGLE_MAP_DELETE_ALL_STYLE_LABEL') . '</button>'
                . '		</li>'
                . '		<li id="style-form"></li>'
                . '		<li >'
 ...
 // setup for manager Styles 
 	var dialogStyleHtml = '<form id="btg-form-style"><div class= "btg-messages" id="btg-sylte-messages" class="clearfix"></div>'
    ...
    + '         <button id="btnCreateStyle" class="btg-green-btn btg-panel-btn"><?php echo JText::_('MOD_BT_GOOGLE_MAP_BUTTON_CREATE_STYLE') ?></button>'
    + '         <button id="btnUpdateStyle" class="btg-green-btn btg-panel-btn"><?php echo JText::_('MOD_BT_GOOGLE_MAP_BUTTON_UPDATE_STYLE') ?></button>'
