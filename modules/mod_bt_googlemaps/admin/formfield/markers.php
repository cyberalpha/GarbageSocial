    ...
    protected function  getInput() {
      ...
      // for maker field
        $html =
                ...
                . '     	<label>&nbsp;</label>'
                . '     	<button id="btnAddMarker" class="btt-green-btn" versionjl="'.JVERSION.'" baseurl=" '.JURI::root().'">' . JText::_('MOD_BT_GOOGLE_MAP_ADD_MARKER_LABEL') . '</button>'
                . '     	<button id="btnDeleteAll" class="btt-red-btn">' . JText::_('MOD_BT_GOOGLE_MAP_DELETE_ALL_MARKER_LABEL') . '</button>'
                . '		</li>'
      ...
      # create script
		...
		foreach ($htmlMediaCode as $key => $value){
			...
			if($key =='icon'){
				...
				$htmlMedia[]= '<label class="hasTip" title="'.JText::_('BT_GOOGLE_MAP_SHADOW_IMAGE_MARKER_DESC').'" for="btg-'.$key.'" aria-invalid="false">'.JText::_('BT_GOOGLE_MAP_SHADOW_IMAGE_MARKER_LABEL').'</label>';
			}
      ...
      ?>
       <script type="text/javascript">
        	var dialogHtml =  '<form id="btg-form-marker"><div class= "btg-messages" id="btg-messages" class="clearfix"></div>'
                ...
                + '         <button id="btnCreateMarker" class="btg-green-btn btg-panel-btn"><?php echo JText::_('MOD_BT_GOOGLE_MAP_BUTTON_CREATE_MARKER') ?></button>'
                + '         <button id="btnUpdateMarker" class="btg-green-btn btg-panel-btn"><?php echo JText::_('MOD_BT_GOOGLE_MAP_BUTTON_UPDATE_MARKER') ?></button>'
                + '         <button id="btnCancel" class="btg-red-btn btg-panel-btn"><?php echo JText::_('MOD_BT_GOOGLE_MAP_BUTTON_CANCEL') ?></button>'
                + '     </li>'
                + '</ul>'
                + '</form>'
                + '<script type="text/javascript">'
