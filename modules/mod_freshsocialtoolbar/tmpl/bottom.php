...
<div id="socialClicks" style="z-index:10000; width: 626px; height: 90px; position: fixed; bottom: -100px; left: 30%;">
	<div id="social-box-left" style="background: url('modules/mod_freshsocialtoolbar/assets/images/bottom/left<?php echo $bordertype;?>.png') no-repeat scroll 0px 0px; width: 60px; height: 90px; float:left"></div>
		<div id="social-box-middle" style="background: url('modules/mod_freshsocialtoolbar/assets/images/bottom/center<?php echo $bordertype;?>.png') repeat-x scroll 0px 0px; padding-top: 11px; height: 90px; width:500px; float:left;">
		<div style="text-align:center;">
		<a class="sliderButton2" style="cursor:pointer; float: left; width: 33px; height: 14px; margin-top: 1px; margin-left: 225px; display: none; background: url('modules/mod_freshsocialtoolbar/assets/images/bottom/btn-slide.jpg') no-repeat scroll <?php if ( $toolbaropen ) : ?>-33px<?php else: ?>0px<?php endif;?> 0px transparent;"></a>
		<a class="sliderButton" style="cursor:pointer; float: left; width: 33px; height: 14px; margin-top: 1px; margin-left: 225px; display: block; background: url('modules/mod_freshsocialtoolbar/assets/images/bottom/btn-slide.jpg') no-repeat scroll <?php if ( $toolbaropen ) : ?>0px<?php else: ?>-33px<?php endif;?> 0px transparent;"></a>				
		</div>
		...
		<div id="social-box-middle-right" style="float: right; width: 58px; margin: 0 27px 0 0;">
			...
			<div class="google" style="margin: 0px 0px 0px 9px; float:left;">
			...
			<div class="twitter" style="margin: 22px 0px 0px 9px; float:left;">
			...
			<!-- twitter follow -->
			<?php if ( $showtwf ): ?>
			<div class="twitter" style="margin: 0px 0px 0px 9px; float:left;">
			...
			<!-- linkedin -->
			<?php if ( $showlinkedin ): ?>
			<div class="linkedin" style="margin: 0px 0px 0px 9px; float:left;">
			...
			<div class="pinterest" style="margin: 20px 0px 0px 9px; float:left;">
			...
			<!-- you tube -->
			<?php if ( $showutube ): ?>
			<div class="utube" style="margin: 15px 0px 0px 9px; float:left;">
			...
			<!-- rss -->
			<?php if ( $showrss ): ?>
			<div class="rss" style="margin: 12px 0px 0px 9px; float:left;">
	...
	<div id="social-box-right" style="background: url('modules/mod_freshsocialtoolbar/assets/images/bottom/right<?php echo $bordertype;?>.png') no-repeat scroll 0px 0px; width: 60px; height: 90px; float:left"></div>
<?php 
