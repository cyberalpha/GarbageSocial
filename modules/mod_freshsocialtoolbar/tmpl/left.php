...
<div id="socialClicks" style="z-index:10000; width: 90px; height: <?php echo $toolbarheight; ?>px; position: fixed; top: <?php echo $topdistance; ?>px; left: -60px;">
	<div id="social-box-top" style="background: url('modules/mod_freshsocialtoolbar/assets/images/left/bg-social-shadow<?php echo $bordertype;?>.png') no-repeat scroll -200px 0px transparent; width: 90px; height: 70px;"></div>
		<div id="social-box-middle" style="background: url('modules/mod_freshsocialtoolbar/assets/images/left/bg-social-shadow<?php echo $bordertype;?>.png') repeat-y scroll 0px 0px transparent; position: relative; padding-bottom: 22px; height: <?php echo $toolbarheight; ?>px;">
			...
			<a class="sliderButton" style="cursor:pointer; position: absolute; top: 50%; float: left; width: 14px; height: 33px; margin-top: -15px; margin-left: 69px; display: block; background: url('modules/mod_freshsocialtoolbar/assets/images/left/btn-slide.jpg') no-repeat scroll 0px <?php if ( $toolbaropen ) : ?>0px<?php else: ?>-33px<?php endif;?> transparent;"></a>
			<a class="sliderButton2" style="cursor:pointer; position: absolute; top: 50%; float: left; width: 14px; height: 33px; margin-top: -15px; margin-left: 69px; display: none; background: url('modules/mod_freshsocialtoolbar/assets/images/left/btn-slide.jpg') no-repeat scroll 0px <?php if ( $toolbaropen ) : ?>-33px<?php else: ?>0px<?php endif;?> transparent;"></a>
		</div>
	<div id="social-box-bottom" style="background: url('modules/mod_freshsocialtoolbar/assets/images/left/bg-social-shadow<?php echo $bordertype;?>.png') no-repeat scroll -100px 0px transparent; width: 90px; height: 70px;"></div>
<?php 
