 ...
 */
 // Created at Thu Jan 17 23:18:26 ART 2013 by Sobi Pro Component

var menuTree_stmcid = 0;
var menuTree_stmLastNode = 158;
...
menuTree_stmImgMatrix[ 154 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 155 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 156 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 157 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 158 ] = new Array( 'join' );;
//__PARENT_ARR__
...
function menuTree_stmExpand( catid, deep, pid ) 
{
	...
	menuTree_stmPid = pid;
	url = "index.php?option=com_sobipro&task=category.expand&sid=153&out=xml&expand=" + menuTree_stmcid + "&pid=" + menuTree_stmPid + "&tmpl=component&format=raw";
