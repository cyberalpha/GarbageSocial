 ...
 */
 // Created at Thu Jan 17 22:40:51 ART 2013 by Sobi Pro Component

var menuTree_stmcid = 0;
var menuTree_stmLastNode = 113;
...
menuTree_stmImgMatrix[ 112 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 114 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 113 ] = new Array( 'join' );;
//__PARENT_ARR__
...
function menuTree_stmExpand( catid, deep, pid ) 
{
	...
	menuTree_stmPid = pid;
	url = "index.php?option=com_sobipro&task=category.expand&sid=103&out=xml&expand=" + menuTree_stmcid + "&pid=" + menuTree_stmPid + "&tmpl=component&format=raw";
