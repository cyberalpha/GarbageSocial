 ...
 */
 // Created at Mon Oct 21 23:05:35 ART 2013 by Sobi Pro Component
...
var sobiCats_stmWait = 'http://localhost/GarbageSocial/media/sobipro/styles/spinner.gif';

sobiCats_stmImgs[ 'root' ] = 'http://localhost/GarbageSocial/media/sobipro/tree/base.gif';
sobiCats_stmImgs[ 'join' ] = 'http://localhost/GarbageSocial/media/sobipro/tree/join.gif';
sobiCats_stmImgs[ 'joinBottom' ] = 'http://localhost/GarbageSocial/media/sobipro/tree/joinbottom.gif';
sobiCats_stmImgs[ 'plus' ] = 'http://localhost/GarbageSocial/media/sobipro/tree/plus.gif';
sobiCats_stmImgs[ 'plusBottom' ] = 'http://localhost/GarbageSocial/media/sobipro/tree/plusbottom.gif';
sobiCats_stmImgs[ 'minus' ] = 'http://localhost/GarbageSocial/media/sobipro/tree/minus.gif';
sobiCats_stmImgs[ 'minusBottom' ] = 'http://localhost/GarbageSocial/media/sobipro/tree/minusbottom.gif';
sobiCats_stmImgs[ 'folder' ] = 'http://localhost/GarbageSocial/media/sobipro/tree/folder.gif';
sobiCats_stmImgs[ 'disabled' ] = 'http://localhost/GarbageSocial/media/sobipro/tree/disabled.gif';
sobiCats_stmImgs[ 'folderOpen' ] = 'http://localhost/GarbageSocial/media/sobipro/tree/folderopen.gif';
sobiCats_stmImgs[ 'line' ] = 'http://localhost/GarbageSocial/media/sobipro/tree/line.gif';
sobiCats_stmImgs[ 'empty' ] = 'http://localhost/GarbageSocial/media/sobipro/tree/empty.gif';;
