 ...
 * $Revision: 992 $
 * $Author: Radek Suski $
 * File location: components/com_sobipro/lib/js/edit.js $
 */
...
function SP_selectCat( sid, add )
{
	...
	var request = new SobiPro.Json(
		"http://garbages-cp77.webjoomla.es/index.php?option=com_sobipro&task=category.parents&out=json&format=raw&tmpl=component" + '&sid=' + sid,
		{
