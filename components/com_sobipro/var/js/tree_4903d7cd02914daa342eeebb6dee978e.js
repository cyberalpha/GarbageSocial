 ...
 */
 // Created at Thu Jan 17 23:08:57 ART 2013 by Sobi Pro Component

var menuTree_stmcid = 0;
var menuTree_stmLastNode = 145;
...
menuTree_stmImgMatrix[ 143 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 144 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 145 ] = new Array( 'join' );;
//__PARENT_ARR__
...
function menuTree_stmExpand( catid, deep, pid ) 
{
	...
	menuTree_stmPid = pid;
	url = "index.php?option=com_sobipro&task=category.expand&sid=142&out=xml&expand=" + menuTree_stmcid + "&pid=" + menuTree_stmPid + "&tmpl=component&format=raw";
