 ...
 */
 // Created at Thu Jan 17 22:54:07 ART 2013 by Sobi Pro Component

var menuTree_stmcid = 0;
var menuTree_stmLastNode = 135;
...
var menuTree_stmWait = 'http://localhost/SocialGarbage/media/sobipro/styles/spinner.gif';

menuTree_stmImgs[ 'root' ] = 'http://localhost/SocialGarbage/media/sobipro/tree/base.gif';
menuTree_stmImgs[ 'join' ] = 'http://localhost/SocialGarbage/media/sobipro/tree/join.gif';
menuTree_stmImgs[ 'joinBottom' ] = 'http://localhost/SocialGarbage/media/sobipro/tree/joinbottom.gif';
menuTree_stmImgs[ 'plus' ] = 'http://localhost/SocialGarbage/media/sobipro/tree/plus.gif';
menuTree_stmImgs[ 'plusBottom' ] = 'http://localhost/SocialGarbage/media/sobipro/tree/plusbottom.gif';
menuTree_stmImgs[ 'minus' ] = 'http://localhost/SocialGarbage/media/sobipro/tree/minus.gif';
menuTree_stmImgs[ 'minusBottom' ] = 'http://localhost/SocialGarbage/media/sobipro/tree/minusbottom.gif';
menuTree_stmImgs[ 'folder' ] = 'http://localhost/SocialGarbage/media/sobipro/tree/folder.gif';
menuTree_stmImgs[ 'disabled' ] = 'http://localhost/SocialGarbage/media/sobipro/tree/disabled.gif';
menuTree_stmImgs[ 'folderOpen' ] = 'http://localhost/SocialGarbage/media/sobipro/tree/folderopen.gif';
menuTree_stmImgs[ 'line' ] = 'http://localhost/SocialGarbage/media/sobipro/tree/line.gif';
menuTree_stmImgs[ 'empty' ] = 'http://localhost/SocialGarbage/media/sobipro/tree/empty.gif';;

menuTree_stmImgMatrix[ 128 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 129 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 130 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 131 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 132 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 133 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 134 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 135 ] = new Array( 'join' );;
//__PARENT_ARR__
...
function menuTree_stmExpand( catid, deep, pid ) 
{
	...
	menuTree_stmPid = pid;
	url = "index.php?option=com_sobipro&task=category.expand&sid=126&out=xml&expand=" + menuTree_stmcid + "&pid=" + menuTree_stmPid + "&tmpl=component&format=raw";
