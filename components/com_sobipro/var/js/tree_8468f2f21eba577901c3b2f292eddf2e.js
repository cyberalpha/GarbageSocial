 ...
 */
 // Created at Thu Jan 17 22:43:03 ART 2013 by Sobi Pro Component

var sobiCats_stmcid = 0;
var sobiCats_stmLastNode = 108;
...
sobiCats_stmImgMatrix[ 106 ] = new Array( 'joinBottom' );
sobiCats_stmImgMatrix[ 107 ] = new Array( 'joinBottom' );
sobiCats_stmImgMatrix[ 108 ] = new Array( 'join' );;
//__PARENT_ARR__
...
function sobiCats_stmExpand( catid, deep, pid ) 
{
	...
	sobiCats_stmPid = pid;
	url = "index.php?option=com_sobipro&task=category.chooser&sid=101&out=xml&expand=" + sobiCats_stmcid + "&pid=" + sobiCats_stmPid + "&tmpl=component&format=raw";
