 ...
 */
 // Created at Thu Jan 17 23:22:57 ART 2013 by Sobi Pro Component

var menuTree_stmcid = 0;
var menuTree_stmLastNode = 162;
...
menuTree_stmImgMatrix[ 160 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 161 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 162 ] = new Array( 'join' );;
//__PARENT_ARR__
...
function menuTree_stmExpand( catid, deep, pid ) 
{
	...
	menuTree_stmPid = pid;
	url = "index.php?option=com_sobipro&task=category.expand&sid=159&out=xml&expand=" + menuTree_stmcid + "&pid=" + menuTree_stmPid + "&tmpl=component&format=raw";
