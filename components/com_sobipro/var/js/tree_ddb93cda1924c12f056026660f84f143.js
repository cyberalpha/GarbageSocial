 ...
 */
 // Created at Wed Oct 23 18:45:08 CEST 2013 by Sobi Pro Component

var sobiCats_stmcid = 0;
var sobiCats_stmLastNode = 141;
...
sobiCats_stmImgMatrix[ 139 ] = new Array( 'joinBottom' );
sobiCats_stmImgMatrix[ 140 ] = new Array( 'joinBottom' );
sobiCats_stmImgMatrix[ 141 ] = new Array( 'join' );;
//__PARENT_ARR__
...
function sobiCats_stmExpand( catid, deep, pid ) 
{
	...
	sobiCats_stmPid = pid;
	url = "index.php?option=com_sobipro&task=category.chooser&sid=138&out=xml&expand=" + sobiCats_stmcid + "&pid=" + sobiCats_stmPid + "&tmpl=component&format=raw";
