 ...
 */
 // Created at Thu Jan 17 22:38:00 ART 2013 by Sobi Pro Component

var menuTree_stmcid = 0;
var menuTree_stmLastNode = 108;
...
menuTree_stmImgMatrix[ 106 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 107 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 108 ] = new Array( 'join' );;
//__PARENT_ARR__
...
function menuTree_stmExpand( catid, deep, pid ) 
{
	...
	menuTree_stmPid = pid;
	url = "index.php?option=com_sobipro&task=category.expand&sid=101&out=xml&expand=" + menuTree_stmcid + "&pid=" + menuTree_stmPid + "&tmpl=component&format=raw";
