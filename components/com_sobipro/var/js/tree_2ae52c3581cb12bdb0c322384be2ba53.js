 ...
 */
 // Created at Thu Jan 17 22:38:45 ART 2013 by Sobi Pro Component

var menuTree_stmcid = 0;
var menuTree_stmLastNode = 118;
...
menuTree_stmImgMatrix[ 115 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 116 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 117 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 118 ] = new Array( 'join' );;
//__PARENT_ARR__
...
function menuTree_stmExpand( catid, deep, pid ) 
{
	...
	menuTree_stmPid = pid;
	url = "index.php?option=com_sobipro&task=category.expand&sid=104&out=xml&expand=" + menuTree_stmcid + "&pid=" + menuTree_stmPid + "&tmpl=component&format=raw";
