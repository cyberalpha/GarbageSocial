 ...
 */
 // Created at Thu Jan 17 22:39:18 ART 2013 by Sobi Pro Component

var menuTree_stmcid = 0;
var menuTree_stmLastNode = 123;
...
menuTree_stmImgMatrix[ 119 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 120 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 121 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 122 ] = new Array( 'joinBottom' );
menuTree_stmImgMatrix[ 123 ] = new Array( 'join' );;
//__PARENT_ARR__
...
function menuTree_stmExpand( catid, deep, pid ) 
{
	...
	menuTree_stmPid = pid;
	url = "index.php?option=com_sobipro&task=category.expand&sid=105&out=xml&expand=" + menuTree_stmcid + "&pid=" + menuTree_stmPid + "&tmpl=component&format=raw";
