 ...
 */
 // Created at Wed Oct 23 18:44:45 CEST 2013 by Sobi Pro Component

var sobiCats_stmcid = 0;
var sobiCats_stmLastNode = 130;
...
var sobiCats_stmWait = 'http://garbages-cp77.webjoomla.es/media/sobipro/styles/spinner.gif';

sobiCats_stmImgs[ 'root' ] = 'http://garbages-cp77.webjoomla.es/media/sobipro/tree/base.gif';
sobiCats_stmImgs[ 'join' ] = 'http://garbages-cp77.webjoomla.es/media/sobipro/tree/join.gif';
sobiCats_stmImgs[ 'joinBottom' ] = 'http://garbages-cp77.webjoomla.es/media/sobipro/tree/joinbottom.gif';
sobiCats_stmImgs[ 'plus' ] = 'http://garbages-cp77.webjoomla.es/media/sobipro/tree/plus.gif';
sobiCats_stmImgs[ 'plusBottom' ] = 'http://garbages-cp77.webjoomla.es/media/sobipro/tree/plusbottom.gif';
sobiCats_stmImgs[ 'minus' ] = 'http://garbages-cp77.webjoomla.es/media/sobipro/tree/minus.gif';
sobiCats_stmImgs[ 'minusBottom' ] = 'http://garbages-cp77.webjoomla.es/media/sobipro/tree/minusbottom.gif';
sobiCats_stmImgs[ 'folder' ] = 'http://garbages-cp77.webjoomla.es/media/sobipro/tree/folder.gif';
sobiCats_stmImgs[ 'disabled' ] = 'http://garbages-cp77.webjoomla.es/media/sobipro/tree/disabled.gif';
sobiCats_stmImgs[ 'folderOpen' ] = 'http://garbages-cp77.webjoomla.es/media/sobipro/tree/folderopen.gif';
sobiCats_stmImgs[ 'line' ] = 'http://garbages-cp77.webjoomla.es/media/sobipro/tree/line.gif';
sobiCats_stmImgs[ 'empty' ] = 'http://garbages-cp77.webjoomla.es/media/sobipro/tree/empty.gif';;

sobiCats_stmImgMatrix[ 129 ] = new Array( 'joinBottom' );
sobiCats_stmImgMatrix[ 131 ] = new Array( 'joinBottom' );
sobiCats_stmImgMatrix[ 133 ] = new Array( 'joinBottom' );
sobiCats_stmImgMatrix[ 135 ] = new Array( 'joinBottom' );
sobiCats_stmImgMatrix[ 132 ] = new Array( 'joinBottom' );
sobiCats_stmImgMatrix[ 134 ] = new Array( 'joinBottom' );
sobiCats_stmImgMatrix[ 128 ] = new Array( 'joinBottom' );
sobiCats_stmImgMatrix[ 130 ] = new Array( 'join' );;
//__PARENT_ARR__
...
function sobiCats_stmExpand( catid, deep, pid ) 
{
	...
	sobiCats_stmPid = pid;
	url = "index.php?option=com_sobipro&task=category.chooser&sid=126&out=xml&expand=" + sobiCats_stmcid + "&pid=" + sobiCats_stmPid + "&tmpl=component&format=raw";
