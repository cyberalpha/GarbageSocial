<?php
/**
 * @version: $Id: config.php 2620 2012-07-30 16:32:28Z Radek Suski $
 ...
 * ===================================================
 * $Date: 2012-07-30 18:32:28 +0200 (Mon, 30 Jul 2012) $
 * $Revision: 2620 $
 * $Author: Radek Suski $
 * File location: components/com_sobipro/lib/base/config.php $
 */
...
class SPConfig
{
                ...
                foreach ( $arr as $section => $values ) {
                    ...
                    if ( !empty( $values ) ) {
                        foreach ( $values as $k => $v ) {
                            ...
                            $currSec[ $k ] = $this->_structualData( $v );
                        }
                    }
                }
            }
    ...
    public function addTable( $table, $id = 0, $section = 'cSection', $key = 'sKey', $value = 'sValue', $object = 'section', $parseObject = true )
    {
        ...
        try {
            ...
            foreach ( $config as $row ) {
                ...
                $this->_store[ $row->configsection ][ $row->sKey ] = $this->_structualData( $row->sValue );
            }
            return true;
        } catch ( SPException $x ) {
    ...
    private function _structualData( $data )
    {
