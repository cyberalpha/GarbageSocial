 ...
 * $Revision: 2375 $
 * $Author: Radek Suski $
 * File location: components/com_sobipro/lib/ctrl/search.php $
 */
	...
	private function verify()
	{
		if( $this->_results ) {
			if( Sobi::My( 'id' ) ) {
				...
				$conditions = array( 'state' => '1', /* 'approved' => '1' ,*/ '@VALID' => $this->_db->valid( 'validUntil', 'validSince' ) );
			}
