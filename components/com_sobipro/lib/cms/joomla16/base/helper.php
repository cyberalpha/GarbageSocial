<?php
/**
 * @version: $Id: helper.php 2616 2012-07-21 12:00:11Z Sigrid Suski $
 ...
 * ===================================================
 * $Date: 2012-07-21 14:00:11 +0200 (Sat, 21 Jul 2012) $
 * $Revision: 2616 $
 * $Author: Sigrid Suski $
 * File location: components/com_sobipro/lib/cms/joomla16/base/helper.php $
 */
...
final class SPCMSHelper extends SPJoomlaCMSHelper
{
	...
	{
		return $recommended ? array( 'major' => 2, 'minor' => 5, 'build' => 6 ) : array( 'major' => 2, 'minor' => 5, 'build' => 0 );
	}
