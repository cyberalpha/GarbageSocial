...
INSERT INTO `#__phocamaps_icon` (`id`, `title`, `alias`, `url`, `urls`, `object`, `objects`, `published`, `checked_out`, `checked_out_time`, `ordering`, `access`, `hits`, `params`, `language`) VALUES
...
-- ALTER TABLE `#__phocamaps_map` ADD `language` char(7) NOT NULL default '' AFTER `params` ;  
-- ALTER TABLE `#__phocamaps_marker` ADD `language` char(7) NOT NULL default '' AFTER `params` ; 
-- ALTER TABLE `#__phocamaps_marker` ADD `iconext` int(11) NOT NULL default '0' AFTER `icon` ;

-- RC -> Stable
-- ALTER TABLE `#__phocamaps_icon` ADD `objectshape` varchar(255) NOT NULL default '' AFTER `objects` ;
