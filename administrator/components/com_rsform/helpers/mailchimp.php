...
<tr>
	<td valign="top" align="left" width="30%">
		<table>
			<tr>
				<td colspan="2"><?php echo JHTML::image('administrator/components/com_rsform/assets/images/mailchimp.jpg', 'MailChimp'); ?></td>
			</tr>
			<tr>
				<td colspan="2"><div class="rsform_error"><?php echo JText::_('RSFP_MAILCHIMP_DESC'); ?></div></td>
			</tr>
			<tr>
