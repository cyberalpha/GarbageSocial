<?php
/**
 * @version: $Id: list.php 704 2011-02-01 17:27:44Z Radek Suski $
 ...
 * ===================================================
 * $Date: 2011-02-01 18:27:44 +0100 (Tue, 01 Feb 2011) $
 * $Revision: 704 $
 * $Author: Radek Suski $
 * File location: administrator/components/com_sobipro/category/list.php $
 */
...
<div style="margin-left: 20.8em; margin-top: 3px;">
	<div class="sheader icon-48-SobiCatList">
		<?php $this->txt( 'CAT.CATEGORY_LIST_HEAD', array( 'category' => $this->get( 'category.name' ) ) ); ?>
	</div>
	...
	<div class="sheader icon-48-SobiEntries">
		<?php $this->txt( 'CAT.ENTRIES_LIST_HEAD', array( 'category' => $this->get( 'category.name' ) ) ); ?>
	</div>
