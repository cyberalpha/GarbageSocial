<?php
/**
 * @version: $Id: select.php 1920 2011-10-06 18:07:18Z Radek Suski $
 ...
 * $Revision: 1920 $
 * $Author: Radek Suski $
 * File location: administrator/components/com_sobipro/field/edit/select.php $
 */
...
<div class="col width-70" style="float: left;">
	<fieldset class="adminform" style="border: 1px dashed silver;">
		<legend>
			<?php $this->txt( 'FM.SELECT_SPEC_PARAMS' ); ?>
		</legend>
		<table class="admintable">
			...
			<tr class="row<?php echo ++$row%2; ?>">
				...
				<td>
					<?php $this->field( 'text', 'field.swidth', 'value:field.swidth', 'id=field_swidth, size=5, maxlength=10, class=inputbox, style=text-align:center;' ); ?>
				</td>
			</tr>
			<tr class="row<?php echo ++$row%2; ?>">
				<td class="key">
