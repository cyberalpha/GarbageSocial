...
('fields_filter', 'website', 'Website w/o Protocol', 'L15bXHdcLi1dK1wuezF9W2EtekEtWl17Miw1fShcL1teXHNdKik/JC8=', 'Please enter a valid website address without protocol in the $field field.', ''),
...
('fields_filter', 'single_letter', 'Single Letter', 'L15bYS16QS1aXSQv', 'The $field field accepts only one letter value.', ''),
('fields_filter', 'phone', 'Phone Number', 'L14oXCtcZHsxLDN9XHM/KT8oXHM/XChbXGRdXClccz8pP1tcZFwtXHNcLl0rJC8=', 'Please enter a valid phone number into the $field field.', ''),
...
('fields_filter', 'alphanum', 'Alphanumeric String', 'L15bYS16QS1aMC05XSskLw==', 'In the $field field, only alphanumeric characters are allowed.', ''),
