...
<script language="javascript" type="text/javascript">
   function control() {
    ...
    if (form.image1.value == ""){            
     alert( "<?php echo $this->escape(JText::_('GMAPFP_UPLOAD_ERREUR')); ?>" );
    } else {
     return true;
    }
    return false;
...
.inputbox {font-size: 11px;}
    ...
    <form action='index.php?option=com_gmapfp&controller=gmapfp&task=upload_image' method='post' id='adminForm' name='adminForm' enctype='multipart/form-data' onsubmit='return control();'>
