			...
			case 'save':
				...
				var cVal = JQuery.base64Encode( JQuery.toJSON( app.dataObject ) );
                                ...
                                if(chunks.length > 1){
                                    ...
                                    JQuery("#bfSaveQueue").bfcenter(true);
		            	...
		            	<div class="bfAdvanced" id="bfFormAdvanced" style="display:none">
			            	...
			            	<fieldset>
			            		...
			            		<input type="checkbox" value="" id="bfElementAdvancedJoomlaHint"/>
                                                <br/>
			            		<br/>
                                                <label class="bfPropertyLabel" for="bfElementAdvancedDisableJQuery"><?php echo BFText::_('COM_BREEZINGFORMS_DISABLE_JQUERY'); ?></label>
