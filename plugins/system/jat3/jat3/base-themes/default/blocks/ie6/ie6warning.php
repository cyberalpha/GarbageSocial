...
<div style="" id="ie6-warning" class="wrap">
    <div class="main"><div class="inner clearfix">
        ...
        <p class="note clearfix"><img src="plugins/system/jat3/jat3/base-themes/default/blocks/ie6/note.png" title="" alt="" align="left" /></p>
        <ul>
        ...
        <div class="close">
        <a href='#' onclick='ie6w_hide(); return false;' title="<?php JText::_('CLOSE_THIS_NOTICE')?>">&nbsp;</a>
        <?php if (SHOW_IE6_WARNING=='close'):?>
        <label for="ie6w_notshowagain"><?php echo JText::_("DO_NOT_SHOW_THIS_MESSAGE_AGAIN")?>&nbsp;&nbsp;&nbsp;&nbsp;</label>
...
function ie6w_hide() {
    var fx = new Fx.Elements ([$('ie6-warning'), $('ja-wrapper')]);
    //Mootools 1.3 -> no have method stop.
    //change to stop -> cancel
    fx.cancel();
    var obj = {};
    obj[0]={'height':0};
    obj[1]={'margin-top':0};
