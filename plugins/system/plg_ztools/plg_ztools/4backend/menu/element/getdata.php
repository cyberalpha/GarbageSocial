...
switch($_REQUEST['type'])
{
	default:{
		...
		$str = '<select size="15" id="'.$_REQUEST['name'].'" name="'.$_REQUEST['name'].'[]" style="height:100px; width:215px;" cols="50" multiple="multiple" class="inputbox">';
...
function replaceValue($string)
{
	...
	$string	= ($string[0] == "/") ? substr($string, 1) : $string;
	return $string;
}
