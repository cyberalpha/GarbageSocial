...
class Minify_CSS_UriRewriter {
    ...
    private static function _processUriCB($m)
    {
        ...
        if ('/' !== $uri[0]                  // root-relative
			...
			$baseUrl = 'http'.((isset($_SERVER['HTTPS']) && !empty($_SERVER['HTTPS']) && (strtolower($_SERVER['HTTPS']) != 'off'))?'s':'').'://'.$_SERVER['HTTP_HOST'];
			$baseUrl = str_replace("/plugins/system/plg_ztools/plg_ztools/libs/minify/index.php", "", $baseUrl.$_SERVER['SCRIPT_NAME']);
