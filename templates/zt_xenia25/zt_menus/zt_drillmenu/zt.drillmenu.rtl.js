function drilldownmenu(setting){
	this.sublevelarrow={src: setting.base + 'zt_drillmenu/images/rtl_arrow.gif', width:'6px', top:'3px', left:'6px'} //full URL to image used to indicate there's a sub level
	this.breadcrumbarrow= setting.base +  'zt_drillmenu/images/rtl_arrow_crum.gif' //full URL to image separating breadcrumb links (if it's defined)
...
drilldownmenu.prototype.buildmenu=function($){
	...
	this.arrowposx=parseInt(this.$arrowimgs.eq(0).css('right')) //get default x position of arrow
	if (window.opera)
