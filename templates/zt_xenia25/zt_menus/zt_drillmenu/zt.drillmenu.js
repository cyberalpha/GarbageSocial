function drilldownmenu(setting){
	this.sublevelarrow={src: setting.base + 'zt_drillmenu/images/arrow.png', width:'6px', top:'3px', left:'6px'} //full URL to image used to indicate there's a sub level
	this.breadcrumbarrow= setting.base +  'zt_drillmenu/images/arrow.png' //full URL to image separating breadcrumb links (if it's defined)
...
drilldownmenu.prototype.buildmenu=function($){
	...
	this.$uls.each(function(i){ //loop through each UL
		...
		if (i==0){ //if topmost UL
			...
			//var $arrowimg=$('<a><div class="arrow-next">1234</div></a>').prependTo($parentli)			
