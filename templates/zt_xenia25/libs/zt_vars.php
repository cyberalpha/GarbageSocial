...
$ztcolorstyle = "ZTXenia25StyleCookieSite";

$get_ms 	= JRequest::getVar('menustyle');
$cookie_ms 	= $ztTools->get_cookie('ztmenustyle_xenia25');

$get_rtl 	= JRequest::getVar('direction');
$cookie_rtl = $ztTools->get_cookie('zt_rtl_xenia25');
...
if($get_ms){
	$menustyle = $get_ms;
	$ztTools->set_cookie('ztmenustyle_xenia25',$get_ms);
}
...
if($get_rtl && ($get_rtl == 'rtl' || $get_rtl == 'ltr') ) {
	$ztrtl = $get_rtl;
	$ztTools->set_cookie('zt_rtl_xenia25',$get_rtl);
}
