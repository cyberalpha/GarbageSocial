	...
	<form action="<?php echo JRoute::_('index.php');?>" method="post" name="emailForm" id="emailForm" class="form-validate">
		...
		<div class="contact-email">
			<div>
				...
				<br /><input type="text" name="name" id="contact-formname" size="30" class="inputbox" value="" />
			</div>
			<div>
				<label id="contact-emailmsg" for="contact-email">
					<?php echo JText::_('JGLOBAL_EMAIL');?>*
				</label>
				<br /><input type="text" id="contact-email" name="email" size="30" value="" class="inputbox required validate-email" maxlength="100" />
			</div>
			<div>
				<label for="contact-subject">
					<?php echo JText::_('COM_CONTACT_CONTACT_MESSAGE_SUBJECT');?>:
				</label>
				<br /><input type="text" name="subject" id="contact-subject" size="30" class="inputbox" value="" />
			</div>
			<div>
				<label id="contact-textmsg" for="contact-text">
					<?php echo JText::_('COM_CONTACT_CONTACT_ENTER_MESSAGE');?>:
				</label>
				<br /><textarea cols="50" rows="10" name="text" id="contact-text" class="inputbox required"></textarea>
			</div>
